 ...
 */
export const unzipResource = (resource, zipFilePath, resourcesPath) => {
 ...
 */
export function processResource(resource, sourcePath, resourcesPath, downloadErrors) {
  try {
    ...
    switch (resource.subject) {
      ...
      case 'TSV_Translation_Notes':
        tnArticleHelpers.processTranslationNotes(resource, sourcePath, processedFilesPath, resourcesPath, downloadErrors);
        break;
