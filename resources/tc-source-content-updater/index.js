 ...
 */
Updater.prototype.updateCatalog = function() {
  this.remoteCatalog = apiHelpers.getCatalog();
};
 ...
 */
Updater.prototype.getLatestResources = function(localResourceList) {
  this.updateCatalog();
 ...
 */
Updater.prototype.downloadResources = function(languageList, resourcesPath,
  ...
  let results = null;
  try {
    results = resourcesDownloadHelpers.downloadResources(languageList, resourcesPath, resources, this.downloadErrors, allAlignedBibles);
  } catch (e) {
 ...
 */
Updater.prototype.moveResources = function(resourceSourcePath, languageCode) {
...
Updater.prototype.downloadAndProcessResource = function(resourceDetails, resourcesPath) {
  ...
  let result = null;
  try {
    result = resourcesDownloadHelpers.downloadAndProcessResource(resource, resourcesPath, this.downloadErrors);
